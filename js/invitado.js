...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const invitados = [
        ...
        { nombre: "Fam. Salazar De la Cruz", numInvitados: 4 },
        { nombre: "Sr y Sra Milian", numInvitados: 2 },
        { nombre: "Sr y Sra Arreaza", numInvitados: 2 },
        ...
        { nombre: "Jorge y Vera", numInvitados: 2 },
        { nombre: "Olgui", numInvitados: 1 },
        { nombre: "Damaso Avila", numInvitados: 1 },
        { nombre: "Noelia Avila", numInvitados: 1 },
        { nombre: "Sr y Sra Perez", numInvitados: 2 },
        { nombre: "Fam. Gomar Peralta", numInvitados: 4 },
        { nombre: "Leslie Peralta", numInvitados: 1 },
        { nombre: "Samantha Peralta", numInvitados: 1 },
        { nombre: "Sr y Sra Reyes", numInvitados: 2 },
        { nombre: "Armando, Josse y Ale", numInvitados: 3 },
        { nombre: "Jeremias Avila", numInvitados: 1 },
        { nombre: "Jhony Avila", numInvitados: 1 },
        { nombre: "Sr y Sra Papa", numInvitados: 2 },
